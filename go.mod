...
require (
	...
	k8s.io/utils v0.0.0-20191114184206-e782cd3c129f // same as sdn-4.4-kubernetes-1.17.2
)
...
replace (
	...
	k8s.io/api => github.com/openshift/kubernetes/staging/src/k8s.io/api v0.0.0-20200128234836-7a71bf4afe82
	k8s.io/apiextensions-apiserver => github.com/openshift/kubernetes/staging/src/k8s.io/apiextensions-apiserver v0.0.0-20200128234836-7a71bf4afe82
	k8s.io/apimachinery => github.com/openshift/kubernetes/staging/src/k8s.io/apimachinery v0.0.0-20200128234836-7a71bf4afe82
	k8s.io/apiserver => github.com/openshift/kubernetes/staging/src/k8s.io/apiserver v0.0.0-20200128234836-7a71bf4afe82
	k8s.io/cli-runtime => github.com/openshift/kubernetes/staging/src/k8s.io/cli-runtime v0.0.0-20200128234836-7a71bf4afe82
	k8s.io/client-go => github.com/openshift/kubernetes/staging/src/k8s.io/client-go v0.0.0-20200128234836-7a71bf4afe82
	k8s.io/cloud-provider => github.com/openshift/kubernetes/staging/src/k8s.io/cloud-provider v0.0.0-20200128234836-7a71bf4afe82
	k8s.io/cluster-bootstrap => github.com/openshift/kubernetes/staging/src/k8s.io/cluster-bootstrap v0.0.0-20200128234836-7a71bf4afe82
	k8s.io/code-generator => github.com/openshift/kubernetes/staging/src/k8s.io/code-generator v0.0.0-20200128234836-7a71bf4afe82
	k8s.io/component-base => github.com/openshift/kubernetes/staging/src/k8s.io/component-base v0.0.0-20200128234836-7a71bf4afe82
	k8s.io/cri-api => github.com/openshift/kubernetes/staging/src/k8s.io/cri-api v0.0.0-20200128234836-7a71bf4afe82
	k8s.io/csi-translation-lib => github.com/openshift/kubernetes/staging/src/k8s.io/csi-translation-lib v0.0.0-20200128234836-7a71bf4afe82
	k8s.io/kube-aggregator => github.com/openshift/kubernetes/staging/src/k8s.io/kube-aggregator v0.0.0-20200128234836-7a71bf4afe82
	k8s.io/kube-controller-manager => github.com/openshift/kubernetes/staging/src/k8s.io/kube-controller-manager v0.0.0-20200128234836-7a71bf4afe82
	k8s.io/kube-proxy => github.com/openshift/kubernetes/staging/src/k8s.io/kube-proxy v0.0.0-20200128234836-7a71bf4afe82
	...
	k8s.io/sample-apiserver => github.com/openshift/kubernetes/staging/src/k8s.io/sample-apiserver v0.0.0-20200128234836-7a71bf4afe82
	k8s.io/sample-cli-plugin => github.com/openshift/kubernetes/staging/src/k8s.io/sample-cli-plugin v0.0.0-20200128234836-7a71bf4afe82
	k8s.io/sample-controller => github.com/openshift/kubernetes/staging/src/k8s.io/sample-controller v0.0.0-20200128234836-7a71bf4afe82
	k8s.io/utils => k8s.io/utils v0.0.0-20191114184206-e782cd3c129f // same as sdn-4.4-kubernetes-1.17.2
