...
require (
	...
	k8s.io/apiserver v1.21.0-rc.0
	k8s.io/client-go v1.21.0-rc.0
	k8s.io/component-base v1.21.0-rc.0
	k8s.io/cri-api v1.21.0-rc.0
	k8s.io/klog/v2 v2.8.0
	k8s.io/kubectl v1.21.0-rc.0
	k8s.io/kubernetes v1.21.0-rc.0 // actually sdn-4.8-kubernetes-1.21.0-rc.0
...
replace (
	...
	k8s.io/api => github.com/openshift/kubernetes/staging/src/k8s.io/api v0.0.0-20210406190112-0dcf98c648c8
	k8s.io/apiextensions-apiserver => github.com/openshift/kubernetes/staging/src/k8s.io/apiextensions-apiserver v0.0.0-20210406190112-0dcf98c648c8
	k8s.io/apimachinery => github.com/openshift/kubernetes/staging/src/k8s.io/apimachinery v0.0.0-20210406190112-0dcf98c648c8
	k8s.io/apiserver => github.com/openshift/kubernetes/staging/src/k8s.io/apiserver v0.0.0-20210406190112-0dcf98c648c8
	k8s.io/cli-runtime => github.com/openshift/kubernetes/staging/src/k8s.io/cli-runtime v0.0.0-20210406190112-0dcf98c648c8
	k8s.io/client-go => github.com/openshift/kubernetes/staging/src/k8s.io/client-go v0.0.0-20210406190112-0dcf98c648c8
	k8s.io/cloud-provider => github.com/openshift/kubernetes/staging/src/k8s.io/cloud-provider v0.0.0-20210406190112-0dcf98c648c8
	k8s.io/cluster-bootstrap => github.com/openshift/kubernetes/staging/src/k8s.io/cluster-bootstrap v0.0.0-20210406190112-0dcf98c648c8
	k8s.io/code-generator => github.com/openshift/kubernetes/staging/src/k8s.io/code-generator v0.0.0-20210406190112-0dcf98c648c8
	k8s.io/component-base => github.com/openshift/kubernetes/staging/src/k8s.io/component-base v0.0.0-20210406190112-0dcf98c648c8
	k8s.io/component-helpers => github.com/openshift/kubernetes/staging/src/k8s.io/component-helpers v0.0.0-20210406190112-0dcf98c648c8
	k8s.io/controller-manager => github.com/openshift/kubernetes/staging/src/k8s.io/controller-manager v0.0.0-20210406190112-0dcf98c648c8
	k8s.io/cri-api => github.com/openshift/kubernetes/staging/src/k8s.io/cri-api v0.0.0-20210406190112-0dcf98c648c8
	...
	k8s.io/sample-apiserver => github.com/openshift/kubernetes/staging/src/k8s.io/sample-apiserver v0.0.0-20210406190112-0dcf98c648c8
	k8s.io/sample-cli-plugin => github.com/openshift/kubernetes/staging/src/k8s.io/sample-cli-plugin v0.0.0-20210406190112-0dcf98c648c8
	k8s.io/sample-controller => github.com/openshift/kubernetes/staging/src/k8s.io/sample-controller v0.0.0-20210406190112-0dcf98c648c8
